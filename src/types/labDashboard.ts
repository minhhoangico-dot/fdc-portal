...
export type LabDashboardTatMetricFocus = 'average' | 'median' | 'requested_to_processing' | 'processing_to_result';
...
export type LabDashboardDetailTab = 'list' | 'source';

export interface LabDashboardDetailSelection {
